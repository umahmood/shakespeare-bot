...
var col1 = []string{"artless", "bawdy", "beslubbering", "bootless", "churlish",
...
var col2 = []string{"base-court", "bat-fowling", "beef-witted", "beetle-headed",
...
var col3 = []string{"apple-john", "baggage", "barnacle", "bladder", "boar-pig",
...
// Insult create a new Shakespearean insult
func Insult() string {
	r1 := random.Intn(len(col1))
	r2 := random.Intn(len(col2))
	r3 := random.Intn(len(col3))
	return preface + " " + col1[r1] + " " + col2[r2] + " " + col3[r3]
}
